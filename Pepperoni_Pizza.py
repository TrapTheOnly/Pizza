...
import Pizza
import Pizza_Program2
import Pepperoni_Checkout
...
class Peppe:
    ...
    def options(self):
        ...
        self.frame.title("Pepperoni Pizza")
        ...
        self.chicken = PhotoImage(file = 'Photos/chicken_resized_gif.gif')
        self.label1 = Label(self.frame, text='Pepperoni Pizza', font='Times 32 bold', 
                            bg = '#f2aca5', fg = '#10c200')
        self.label1.grid(row=1, column=0, columnspan = 3, sticky =N)
        self.pizza = Pizza.PizzaBuilder('Pepperoni')
        ...
        self.chicken_label = Label(self.frame, image = self.chicken, bg = '#f2aca5')
        self.chicken_label.grid(row=4, column=1, rowspan = 3, sticky = E) 
        ...
        self.button_chicken = Button(self.frame, text = 'Add Chicken', bg = '#f2aca5', 
                                    fg = 'black', font = 'Times 18 bold',
                                    activebackground = 'red',
                                    command = self.Chikcen)
        self.button_chicken.grid(row=7, column=1, sticky=S)
    ...
    def Chikcen(self):
        self.pizza.add_extention('Chicken')
        self.button1 = Button(self.frame, 
                            command = self.print_added.configure(text='Added Chicken'))
        self.button1.after(10, self.button1.invoke)
        #print(self.pizza.get_price(),'$')
        #print(self.pizza.get_status())
        self.button2 = Button(self.frame,
    ...
    def checkout(self):
        check = Pepperoni_Checkout.Checkout(self.pizza)
        self.frame.destroy()